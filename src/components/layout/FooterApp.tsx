...
export const FooterApp = () => {
  return (
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <div className="flex items-center gap-2 mb-4">
             <LogoEcuSol size={40} />
             <span className="text-white font-bold text-lg">Banco EcuSol</span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-center gap-2 text-gray-400">
              <Phone size={16} className="text-ecusol-secundario"/> 1800-ECUSOL (328765)
            </li>
            <li className="flex items-center gap-2 text-gray-400">
              <Mail size={16} className="text-ecusol-secundario"/> contacto@ecusol.com
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
        <p>© 2025 Banco EcuSol S.A. Todos los derechos reservados.</p>
