//src/pages/public/PaginaUbicanos.tsx
...
const PaginaUbicanos = () => {
  ...
  useEffect(() => {
    // Aquí llamamos al servicio que devuelve las sucursales (mock o real)
    ...
    <div className="bg-white py-16">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Encuentra la oficina de Banco EcuSol más cercana a ti.</p>
        </div>
